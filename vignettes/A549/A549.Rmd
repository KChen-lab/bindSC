...
User can refer to `A549_preprocess.ATAC.html` and `A549_preprocess.RNA.html` for the details of running the pre-processing workflow (It will take 10 ~ 20 mins). For RNA data, there are 6,005 cells measured on 4,759 genes (`A549_RNA$X`). For ATAC data, there are 3,628 cells measured on 13,515 genes (gene activity estimated from peak; `A549_ATAC$Z0`) and 24,953 peaks (`A549_ATAC$Y`).  
